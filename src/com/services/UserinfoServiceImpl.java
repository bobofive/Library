...
public class UserinfoServiceImpl implements UserinfoService {
	...
	public boolean deleteUserinfo(Integer userId) {
		// TODO Auto-generated method stub
		try {
			baseDao.delete(Userinfo.class,userId);
		} catch (Exception e) {
	...
	public List getUserinfoById(Integer userId) {
		// TODO Auto-generated method stub
		String hql="select new map(u.userId as userId,u.userName as userName,u.userSex as userSex,u.phoneNum as phoneNum,u.email as email,u.friendId as friendId,m.majorName as majorName,s.scademyName as scademyName) from Userinfo u,Majorinfo m,Scademyinfo s where u.userId="
